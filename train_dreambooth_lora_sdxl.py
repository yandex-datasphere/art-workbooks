...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=1024,
        help=(
            "The horizontal resolution for input images, all the images in the train/validation dataset will be resized to this"
            " resolution"
        ),
    )
    parser.add_argument(
        ...
        default=1024,
        help=(
            "The width resolution for input images, all the images in the train/validation dataset will be resized to this"
            " resolution"
        ),
    )
    parser.add_argument(
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.image_transforms = transforms.Compose(
            [
                transforms.Resize((size_h,size_w), interpolation=transforms.InterpolationMode.BILINEAR),
                transforms.CenterCrop((size_h,size_w)) if center_crop else transforms.RandomCrop((size_h,size_w)),
                transforms.ToTensor(),
                transforms.Normalize([0.5], [0.5]),
            ]
        )
...
def main(xargs):
    ...
    train_dataset = DreamBoothDataset(
        ...
        size_w=args.resolution_w,
        size_h=args.resolution_h,
